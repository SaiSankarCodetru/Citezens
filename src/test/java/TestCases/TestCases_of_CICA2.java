...
public class TestCases_of_CICA2{
	...
	public void Step_1() throws Exception {
		Step_1Page2Garuntee user = new Step_1Page2Garuntee(driver, Reports);
...
//	}
	...
	@Test(priority = 8)
	public void Step_6() throws Exception {
		Step_6PageRedirection user = new Step_6PageRedirection(driver, Reports);
		user.Predetermination_Questions();
