...
public class Step_1Page {
	...
	public Step_1Page(WebDriver driver, Extent_Reports e) {
	...
	@FindBy(xpath="//ion-input[@formcontrolname='ProposedAge']/input")
	WebElement age;
 
	@FindBy(xpath="(//ion-col[@size='24' and @size-md='4' and @class='md hydrated']/following-sibling::ion-col[@size='24' and"
			+ " @class='md hydrated'])[3]")
	WebElement Error_Message_Age;
	...
	@FindBy(xpath = "//ion-button[.='Calculate']")
	WebElement calculate;
 
	@FindBy(xpath = "//span[normalize-space()='Step 2: Proposed Insured Information']")
	WebElement step_2;
 
	@FindBy(xpath = "//ion-label[.='Date of Birth']")
	WebElement DOB_text;
 
	@FindBy(xpath = "//h3[.='Proposed Insured Info']")
	WebElement piif;
	...
	public void Product_Information() throws Exception {
		...
		C.Send_verify_Valid_C(driver, LastName, e, "Allen",  Test.Case1(6),Test.Exp1(6));
		...
		C.Empty_Input2(driver,FaceAmount, ErrorMessage_FaceAmount, Mandate_Error, e,  Test.Case1(36),Test.Exp1(36));
		...
		String strNumber = age.getAttribute("value");
		System.out.println("String Age is - "+strNumber);
		
		C.Error_Verify(driver, Error_Message_Age, "The maximum amount is 85.", e, Test.Case1(60),Test.Exp1(60));//
		
		C.MX_SC(driver, act, DateOfBirth, calculate,DateOfBirth, ErrorMessage_FaceAmount, "01011940", "The maximum amount is 10000.",
				e, Test.Case1(61),Test.Exp1(61));//
		
		C.MX_SC2(driver, act, DateOfBirth, calculate, ErrorMessage_FaceAmount, "01011970", "The maximum amount is 20000.",
				e, Test.Case1(62),Test.Exp1(62));// .
		...
		C.Send_verify_Valid_C(driver, FaceAmount, e, "2625", Test.Case1(32),Test.Exp1(32));
