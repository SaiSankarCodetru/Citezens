...
public class Step_1Page {
	...
	public void Product_Information() throws Exception {
		...
		C.Send_verify_Valid_C(driver, FirstName, e, "Prasanna", Test.Case1(1), Test.Exp1(1));

		C.Max_Char(driver, MiddleName, Error_Message_MiddleName, Max_Char,  Max_Error, e,Test.Case1(5) ,Test.Exp1(5));

		C.Send_verify_Valid_C(driver, MiddleName, e, "Penta", Test.Case1(2),Test.Exp1(2));
		...
		C.Send_verify_Valid_C(driver, LastName, e, "Mary",  Test.Case1(6),Test.Exp1(6));
